...
func main() {
	...
	title := flag.String("title", "alarm", "Title of the generated diagram")
	notes := flag.String("notes", "", "Comma separated list of notes to be added to the diagram")
	output := flag.String("output", "C:/Users/fanggz/Desktop/goplantuml/output/world.txt", "output file path. If omitted, then this will default to standard output")
